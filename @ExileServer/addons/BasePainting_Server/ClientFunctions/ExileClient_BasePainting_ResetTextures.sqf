/*
* 	Name: ExileClient_BasePainting_ResetTextures.sqf
* 	Author(s): Shix
* 	Description: ResetObject Textures
*/
...
["ResetBasePartRequest",[BasePainting_SelectedItem,_defaultTextures]] call ExileClient_system_network_send;
