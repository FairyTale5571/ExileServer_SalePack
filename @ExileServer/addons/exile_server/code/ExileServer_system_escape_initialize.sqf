...
ExileEscapeThreadSpawnID = [60, ExileServer_system_escape_thread_spawn, [], true] call ExileServer_system_thread_addtask;
ExileEscapeTeleportID = [0.5, ExileServer_system_escape_teleport, [], true] call ExileServer_system_thread_addtask;
true