...
{	
	...
	//все параметры ниже требуют PvE_status = 1;
	allowHotwire = 0;		//разрешить взлом машин
	allowScanCodeLock = 0;  //разрешить сканировать замки
...
class CfgLockBypass
{
	owner = 1; //Установите 0, чтобы отключить этот уровень и заставить вводить код каждый раз
	moderator = 1; //Установите 0, чтобы отключить этот уровень и заставить вводить код каждый раз
	buildRights = 1; //Установите 0, чтобы отключить этот уровень и заставить вводить код каждый раз
	doors = 1; //Установите 0 чтобы открывать двери без кода
	storage = 1; //Установите 0 чтобы открывать хранилища(сейфы например) без кода
};
class CfgAtlasSpawnItemsOnPos
{
	debug = true;
	posAndItem[] = 
	{
		{
			{0,0,0},			//Позиция getPosWorld
			{"Exile_Item_AlsatianSteak_Raw",2},		//Предмет|количество
			60 										//Время в секундах
		},
		{
			{0,0,0},			//Позиция getPosWorld
			{"Exile_Item_AlsatianSteak_Raw",1},		//Предмет|количество
			60 										//Время в секундах
		},
		{
			{0,0,0},			//Позиция getPosWorld
			{"Exile_Item_AlsatianSteak_Raw",3},		//Предмет|количество
			60 										//Время в секундах
		}
	};
};
...
class CfgSecondaryWeapons
{
	...
	*/
	...
	SecondaryWeapons_player_hook = "custom\scripts\SecondaryWeapons_player_hook.sqf";
	
};
class CfgAtlasVirtualGarage
{
	//Параметры для виртального гаража одиночки
	//Доступно если вы приобрели DLC для сборки. Пишите за покупкой
	...
	//Транпспорт который нельзя ставить в гараж
	restrictedVehicles[] =
	{
		"CLASSNAME",
		"CLASSNAME2"
...
{
	class weaponClassName  { allowedUids[] = {"UID1","UID2"}; };
	class weaponClassName2 { allowedUids[] = {"UID1","UID2"}; };
	class weaponClassName3 { allowedUids[] = {"UID1","UID2"}; };
};
class CfgMostWanted
{
    class Database
...
{
	BlockExplosisvesTrader[] =
    {
        {"ExileTraderZoneIcon", 500},
        {"ExileAircraftTraderIcon", 50},
        {"ExileBoatTraderIcon", 50}
    };
	penaltyNearSafeZone = 1; 	//1-да, 0 - нет
	radiusPenalty = 300; 	//радиус трейда с пенальти
	blockFlipVehicle[] =	//Какой транспорт запретить переворачивать на сейф-зоне
	{
		"C_Kart_01_F",
		"C_Kart_01_Fuel_F",
	...
	//Отключить таран игрока техникой
	disableRamming = 1;
	enableESP = 1;
	distanceESP = 20;
	...
	/*
		Только red или green
		Никаких других указывать нельзя, увы.
	*/
	
	colorBorder = "red";
};

class CfgTaskForceRadio
{
	/**
	...
	*/
	...
	//UID игроков, для которых проверка работать не будет
	ignoreCheck[] = {"UID1","UID2"}; 

	//Название сервера тимспик
	TeamSpeakServerName = "";
...
class AVS
{
	...
	AVS_VehicleWeaponBlacklist[] =
	{
		...
		// ["VehicleClassName2", ["WeaponClassName1", "WeaponClassName2", ...]]
	};
...
class CfgDailyReward
{
	...
	box = "Box_NATO_Wps_F";				//Тип коробки
	crateWeapons[] =		//Возможное оружие
	{
		"srifle_DMR_02_F",
		"srifle_GM6_F",
		"srifle_LRR_F",
	...
	crateBackpaks[] = 		//Возможный рюкзак
	{
		"B_Carryall_ghex_F",
		"B_Bergen_mcamo_F",
...
class CfgExAd
{
	class CHVD
	{
		CHVD_allowNoGrass = 1;							//Разрешить отключать траву
		CHVD_maxView = 5000;							//Дальность прорисовки
		CHVD_maxObj = 2000;								//Дальность прорисовки объектов
	};
	class DeployVehicle
	{
		Item = "Exile_Item_DuctTape";					//Что нужно для спавна
		Vehicle = "Exile_Bike_QuadBike_Black";			//Что будем спавнить
	};
};
 
class CfgRestartWarnings
{
	restartStatusBar = 4; //Рестарты в статус-баре, укзывать в часах
    class dynamic
    {
		interval = 4; //С каким интервалом проходят рестарты
    };
    class scheduled
    {
        schedule[] = {4,8,12,16,20,24}; // Рестарты по расписанию, писать время в 24х часовом формате
    };
    forceLeave = 1; // кикнуть всех игроков перед рестартом, писать в минутах, - 0 чтобы отключить
    giveWarningsAt[] = {30,20,10,5,2,1}; //Выдавать предупреждения о рестарте за ... мин до рестарта
    mode = 1; // 1 = динамический | 2 = по расписанию
};
//динамический режим: рестарт будет считаться от запуска сервера
...
class CfgAirDrop
{
	...
	AirDrop_rareItem[] = 
	{
		"Exile_Item_Laptop","Exile_Item_BaseCameraKit","Exile_Item_SafeKit","Exile_Item_CodeLock"
	};
	AirDrop_BoxConstruction[] = 
	{
		"Exile_Item_WoodWallKit","Exile_Item_WoodWallHalfKit","Exile_Item_WoodWindowKit","Exile_Item_WorkBenchKit","Exile_Item_WoodFloorPortKit","Exile_Item_WoodFloorKit","Exile_Item_WoodGateKit"
	};
	AirDrop_BoxTools[] = 
	{
		"Exile_Item_Rope","Exile_Item_DuctTape","Exile_Item_ExtensionCord","Exile_Item_FuelCanisterFull","Exile_Item_JunkMetal","Exile_Item_LightBulb","Exile_Item_MetalBoard","Exile_Item_MetalPole","Exile_Item_CamoTentKit"
	};
	AirDrop_BoxFood[] = 
	{
	...
	AirDrop_BoxWeapons[] = 
	{
		"LMG_Zafir_F","MMG_01_hex_F","srifle_EBR_F","srifle_DMR_01_F","srifle_GM6_F","srifle_LRR_F","srifle_DMR_02_F","MMG_01_tan_F","MMG_02_camo_F","MMG_02_black_F","MMG_02_sand_F","srifle_DMR_03_F","srifle_DMR_03_khaki_F","srifle_DMR_03_tan_F","srifle_DMR_04_F","srifle_DMR_04_Tan_F","srifle_DMR_05_blk_F","srifle_DMR_05_tan_F","srifle_DMR_05_hex_F","srifle_DMR_06_camo_F","srifle_DMR_06_olive_F","srifle_LRR_camo_F","srifle_GM6_camo_F","Exile_Weapon_AK107","Exile_Weapon_AK107_GL","Exile_Weapon_AK74_GL","Exile_Weapon_AK74","Exile_Weapon_AK47","Exile_Weapon_AKS_Gold","Exile_Weapon_LeeEnfield","Exile_Weapon_CZ550","hlc_rifle_aug","hlc_rifle_auga1carb","hlc_rifle_auga2","hlc_rifle_auga2carb","hlc_rifle_auga2lsw","hlc_rifle_auga3","hlc_rifle_auga3_gl","hlc_rifle_aughbar","hlc_rifle_augsr","hlc_rifle_augsrcarb","hlc_rifle_augsrhbar","hlc_rifle_ak12","hlc_rifle_ak12gl","hlc_rifle_ak12gl","hlc_rifle_ak47","hlc_rifle_ak74","hlc_rifle_ak74_mtk","hlc_rifle_ak74m","hlc_rifle_ak74m_gl","hlc_rifle_ak74m_mtk","hlc_rifle_akm","hlc_rifle_akm_mtk","hlc_rifle_akmgl","hlc_rifle_aks74","hlc_rifle_aks74_gl","hlc_rifle_aks74_mtk","hlc_rifle_aks74u","hlc_rifle_aks74u_mtk","hlc_rifle_aku12","hlc_rifle_rk62","hlc_rifle_aek971","hlc_rifle_aek971_mtk","hlc_rifle_g36a1","hlc_rifle_g36a1ag36","hlc_rifle_g36c","hlc_rifle_g36cmlic","hlc_rifle_g36ctac","hlc_rifle_g36cv","hlc_rifle_g36e1","hlc_rifle_g36e1ag36","hlc_rifle_g36ka1","hlc_rifle_g36ke1","hlc_rifle_g36kmlic","hlc_rifle_g36ktac","hlc_rifle_g36kv","hlc_rifle_g36mliag36","hlc_rifle_g36mlic","hlc_rifle_g36tac","hlc_rifle_g36v","hlc_rifle_g36vag36","hlc_rifle_slr","hlc_rifle_slr107u","hlc_rifle_slr107u_mtk","hlc_rifle_slrchopmod","hlc_rifle_stg58f","hlc_rifle_stgw57","arifle_SPAR_03_blk_F","arifle_SPAR_03_khk_F","arifle_SPAR_03_snd_F","Exile_Weapon_DMR","Exile_Weapon_VSSVintorez","hlc_rifle_rpk","hlc_rifle_RPK12","hlc_rifle_rpk74n","hlc_rifle_mg36","hlc_rifle_g3a3","hlc_rifle_g3a3ris","hlc_rifle_g3a3v","hlc_rifle_g3ka4","hlc_rifle_g3ka4_gl","hlc_rifle_l1a1slr","hlc_rifle_lar","hlc_rifle_m4","hlc_rifle_m4m203","hlc_rifle_osw_gl","hlc_rifle_ru556","hlc_rifle_ru5562","hlc_rifle_samr","hlc_rifle_samr2","hlc_rifle_sig5104","hlc_rifle_stgw57_commando","hlc_rifle_stgw57_ris","Exile_Weapon_SVD","Exile_Weapon_SVDCamo","hlc_rifle_hk33a2","hlc_rifle_hk33a2ris","hlc_rifle_hk51","hlc_rifle_hk53","hlc_rifle_hk53ras","hlc_rifle_amt","hlc_rifle_bcmjack","hlc_rifle_bushmaster300","hlc_rifle_c1a1","hlc_rifle_colt727","hlc_rifle_colt727_gl","hlc_rifle_cqbr","hlc_rifle_fal5000","hlc_rifle_fal5000rail","hlc_rifle_fal5061","hlc_rifle_fal5061rail","hlc_rifle_falosw","hlc_rifle_honeybadger","hlc_rifle_vendimus","hlc_lmg_M249E2","hlc_lmg_m249para","hlc_lmg_M60","hlc_lmg_M60E4","hlc_lmg_minimi","hlc_lmg_minimi_railed","hlc_lmg_minimipara","hlc_lmg_mk48","hlc_m249_pip1","hlc_m249_pip2","hlc_m249_pip3","hlc_m249_pip4","hlc_m249_squantoon","hlc_rifle_awcovert","hlc_rifle_awcovert_BL","hlc_rifle_awcovert_FDE","hlc_rifle_awmagnum","hlc_rifle_awmagnum_bl","hlc_rifle_awmagnum_bl_ghillie","hlc_rifle_awmagnum_fde","hlc_rifle_awmagnum_fde_ghillie","hlc_rifle_awmagnum_OD_ghillie","hlc_rifle_m1903a1","hlc_rifle_m1903a1_unertl","hlc_rifle_M1903A1OMR","hlc_rifle_m14","hlc_rifle_m14_bipod","hlc_rifle_m14_rail","hlc_rifle_m14dmr","hlc_rifle_m14sopmod","hlc_rifle_m21","hlc_rifle_g3sg1","hlc_rifle_PSG1A1_RIS","hlc_rifle_psg1"
	};
};
 
class CfgXM8
{
	extraApps[] = {"ExAd_SB","ExAd_Info","ExAd_CHVD","ExAd_Journal","BRAmaRecipes","APPS_Bike","AirDrop","APPS_chat"};
	...
	class AirDrop 
	{
		...
		onLoad = "ExAdClient\XM8\Apps\AirDrop\onLoad.sqf";
		onOpen = "ExAdClient\XM8\Apps\AirDrop\onOpen.sqf";
		onClose = "ExAdClient\XM8\Apps\AirDrop\onClose.sqf";
	};
	class APPS_chat
	{
		title = "Private Chat";
		logo = "ExAdClient\XM8\Apps\XM8_Chat.paa";
...
class CfgClans
{
	...
	*/
	...
	maximumPartyMembers = 10;
	
	/*
		Временно недоступно
	*/
	maximumClanModerators = 0;
};
...
class CfgExileLootSettings
{
	...
	/**
		Спавнить лут в праздничных коробках
	**/
	newYearGifts = false;
};
...
class CfgInteractionMenus
{
	class VirtualGarage
    {
        ...
        class actions
        {
            ...
            class OpenVirtualGarage 
            {
                ...
                condition = "(!isNil 'Atlas_VirtualGarage_haveDLC') && (getNumber(missionConfigFile >> 'CfgAtlasVirtualGarage' >> 'enableGarage') isEqualTo 1)";
                action = "call fnc_openVirtualGarage";
            };
        };
    };
	class Bounties
	{
		...
		class Actions
		{
			...
			class Marxet: ExileAbstractAction
			{
				title = "<img image='\a3\ui_f\data\IGUI\Cfg\Actions\reammo_ca.paa' size='1' shadow='false' />Access MarXet";
				condition = "true";
				action = "createDialog 'RscMarXetDialog';";
			};
		};
	};
...
class CfgPlayer 
{
	...
	//Number of suicides allowed per restart
	MaxSuicides = 6;  
	//Максимальное количество меток на карте (Shift + LBM)
	maxWaypointOnMap = 5;	
};
...
class CfgTerritories
{
	...
	//Время кд появления на флаге в секундах
	timerSpawn = 1800;
	
	//Необходимый уровень флага для включения точки спавна на флаге
	LevelToSpawn = 1;
	
	//Maximum height base
	MaximumBuildHeight = 20;
	...
	//Максимальное количество прописок в базе
	maximumMembersInTerritory = 5;

	//Максимальное количество допустимых прописок для одного игрока
	maximumMemberTerritoryPerPlayer = 5;
	...
	/**
		Если транспорт стоит на территории владельца этого транспорта, то машина не будет получать урон до тех пор пока на сервер не зайдет ее владелец. 
		Защита включается только после рестарта сервера.
	*/
	enableProtectionVehicles = false;
};
...
class CfgTrading 
{
	...
	*/
	...
	/*
		Предметы за которые не будут давать респект при продаже. 
		
		wasteDump продажа не учитывает этот список и все равно начисляет респект, пока что.
	*/
	noRespectItem[] =
	{
