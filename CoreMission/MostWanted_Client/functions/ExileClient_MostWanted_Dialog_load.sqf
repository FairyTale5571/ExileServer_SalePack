...
if(getNumber(missionConfigFile >> "CfgPvE" >> "PvE_status") isEqualTo 1) then {closeDialog 4004; ["ErrorTitleAndText",["This PvE server. Bounties disabled"]] call ExileClient_gui_toaster_addTemplateToast;};
