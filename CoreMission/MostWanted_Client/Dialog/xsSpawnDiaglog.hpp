...
//											//
//////////////////////////////////////////////
#include "xsSpawnDefines.hpp"
class EPSpawnDialog
{
	idd = 86000;
	duration = -1;
	onLoad = "uiNamespace setVariable ['EPSpawnDialog', _this select 0];";
	onUnload = "uiNamespace setVariable ['EPSpawnDialog', displayNull];";
	...
	class Controls
	{
		class xsSpawnBackground: xsSpawnRscPicture
		{
			...
			w = "safezoneW";
			h = "safezoneW * 4/3";
			text = "custom\gui\xsbackground.paa"; 	//сюда указать картнику
		};
		class xsSpawnLogo: xsSpawnRscPictureKeepAspect
		{
			...
			w = 0.156 * safezoneW;
			h = 0.156 * safezoneH;
			text = "custom\gui\xslogo.paa";			//сюда указать картнику
		};
		class xsSpawnHalo: xsSpawnRscButton
		{
			...
			onButtonClick = "call fnc_ButtonClick2; closeDialog 86000;";
		};
		class xsSpawnGround: xsSpawnRscButton
        {
			...
			colorFocused[] = {"199/255","38/255","81/255",0.8};
			colorBackgroundActive[] = {"199/255","38/255","81/255",0.8};
			onButtonClick = "call fnc_ButtonClick; closeDialog 86000;";
		};
