_cleanGrass = getNumber(missionConfigFile >> "CfgExAd" >> "CHVD" >> "CHVD_allowNoGrass");
if(_cleanGrass isEqualTo 1) then
{
	CHVD_allowNoGrass = true; 	
}else{
	CHVD_allowNoGrass = false; 	
};
CHVD_maxView = getNumber(missionConfigFile >> "CfgExAd" >> "CHVD" >> "CHVD_maxView");

CHVD_maxObj = getNumber(missionConfigFile >> "CfgExAd" >> "CHVD" >> "CHVD_maxObj");
