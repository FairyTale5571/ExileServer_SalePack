class RscDisplayRestartWarnings
{
   duration = 999999;
   idd = 7771;
   onLoad = "if isNull (uiNamespace getVariable ['RscDisplayRestartWarnings', displayNull]) then { uiNamespace setVariable ['RscDisplayRestartWarnings', _this select 0]; ExecVM 'custom\restartWarnings\sqf\onLoad.sqf' }";
   #define GUI_GRID_X	(0)
   #define GUI_GRID_Y	(0)
