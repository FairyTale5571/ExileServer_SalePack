...
_progress = 0;
_actionConfig = if !(isClass(missionConfigFile >> "CfgExileDelayedActions" >> _actionName)) then {configFile >> "CfgExileDelayedActions" >> _actionName}else{missionConfigFile >> "CfgExileDelayedActions" >> _actionName};
