...
if (isNil"ExileClientConstructionTextures") then {ExileClientConstructionTextures = [];};
["swapConstructionRequest",[netid _object, _staticObjectClassName, [_position,_vectorDirection,_vectorUp,_velocity,ExileClientConstructionTextures]]] call ExileClient_system_network_send;
ExileClientConstructionTextures = [];
true
