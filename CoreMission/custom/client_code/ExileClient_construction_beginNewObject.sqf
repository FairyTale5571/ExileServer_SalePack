...
_MaximumBuildHeight = getNumber (missionConfigFile >> "CfgTerritories" >> "MaximumBuildHeight");
_playerHeight = (getPosATL ExileClientConstructionObject) select 2;
if (_playerHeight >= _MaximumBuildHeight) exitWith
{
