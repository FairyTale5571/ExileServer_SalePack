...
class Bones_Service_Point
{
	...
	class Controls
	{
		class vms_leftList
		{
			...
			onLBDblClick = "['repair_rearm_opts', (_this select 0) lbData (_this select 1)] call bones_fnc_performAction";
		...
		class vms_reloadAllButton
		{
			...
			soundEscape[] = {"\A3\ui_f\data\sound\RscButton\soundEscape",0.09,1.0};
			soundPush[] = {"\A3\ui_f\data\sound\RscButton\soundPush",0.09,1.0};
			onButtonClick = "['rearmall'] call bones_fnc_performAction";
		...
		class vms_refuelButton
		{
			...
			soundEscape[] = {"\A3\ui_f\data\sound\RscButton\soundEscape",0.09,1.0};
			soundPush[] = {"\A3\ui_f\data\sound\RscButton\soundPush",0.09,1.0};
			onButtonClick = "['refuel'] call bones_fnc_performAction";
		...
		class vms_repairAllButton
		{
			...
			soundEscape[] = {"\A3\ui_f\data\sound\RscButton\soundEscape",0.09,1.0};
			soundPush[] = {"\A3\ui_f\data\sound\RscButton\soundPush",0.09,1.0};
			onButtonClick = "['repairall'] call bones_fnc_performAction";
